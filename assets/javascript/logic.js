...
$(document).ready(function () {
    ...
    yelpAutocomplete();
     ...
     //Function to build the API call based on the user selections
    ...
    //Ajax function that calls Yelp API when a user enters a location and restaurant
    ...
    //Function to capture specific parameters from a returned JSON object
    ...
    //Add an event listener to the database to pass parameters and evoke function to render Bootstrap cards when a new restaurant is added to the database and on window load
    database.ref().on("child_added", function (snapshot) {
        ...
        //Pass database values as arguments to a function that renders a card for each restaurant
   ...
   //Function to render cards using arguments passed in from database
    ...
    //Add a selected date to the database
    ...
    //Remove a restaurant from the database and page when the trash icon is clicked
    $(".container").on("click", ".fa-trash-o", function (event) {
        ...
        var deleteResult = database.ref().child(firebaseId).remove(function (error) {
            console.log("During removal of " + firebaseId + " an error occurred " + error);
        });
